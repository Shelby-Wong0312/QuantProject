...
class IndicatorCalculator:
        ...
        for i in range(0, total, batch_size):
            ...
            for symbol in batch:
                ...
                if (successful + failed) % 50 == 0:
                    ...
                    logger.info(f"Progress: {successful + failed}/{total} "
    ...
    def generate_summary_report(self):
        ...
        report = {
            ...
            'golden_cross_stocks': golden_cross_stocks['symbol'].tolist() if not golden_cross_stocks.empty else []
        }
        
        # Save report
        report_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),
                                  'reports', 'indicator_report.json')
