...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(
            os.path.join(os.path.dirname(__file__), "..", "..", "logs", "download.log")
        ),
...
class FullDataDownloader:
    ...
    def __init__(self):
        ...
        self.db_path = os.path.join(
            os.path.dirname(__file__), "..", "..", "data", "quant_trading.db"
        )
    ...
    def save_checkpoint(self):
        ...
        self.checkpoint["progress"] = (
            self.stats["completed_tickers"] / max(self.stats["total_tickers"], 1)
        ) * 100
    ...
    def get_historical_data(self, symbol: str, epic: str) -> Dict:
        ...
        try:
            ...
            return {"daily": pd.DataFrame(daily_data), "success": True}
    ...
    def download_all_stocks(self):
        ...
        ticker_file = os.path.join(
            os.path.dirname(__file__), "..", "..", "data", "tradable_tickers.txt"
        )
