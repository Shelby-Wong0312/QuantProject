...
def demo_single_indicators():
    ...
    print(
        f"MACD last values - Line: {macd_result['macd'].iloc[-1]:.3f}, Signal: {macd_result['signal'].iloc[-1]:.3f}"
    )
    ...
    print(
        f"Bollinger Bands - Upper: {bb_result['upper_band'].iloc[-1]:.2f}, Lower: {bb_result['lower_band'].iloc[-1]:.2f}"
    )
