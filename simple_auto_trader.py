...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("simple_trader.log"), logging.StreamHandler()],
)
    ...
    def calculate_signals(self, symbol: str) -> Optional[str]:
        ...
        try:
            ...
            if (
                ...
                and current_price > current_ma10  # Above short term trend
                and current_ma10 > current_ma20  # Uptrend
                and volume_surge  # Volume confirmation
                and price_change_1d > 0.01
            ):  # Positive momentum
                return "BUY"
            ...
            # SELL Signals (for existing positions)
                ...
                or current_price < current_ma20  # Below trend
                or price_change_1d < -0.02
            ):  # Negative momentum
                return "SELL"
        ...
        try:
            if signal == "BUY" and len(self.positions) < self.max_positions:
                ...
                if self.place_order(symbol, "SELL", position["size"]):
                    ...
                    logger.info(
                        f"SELL: {position['size']} shares of {symbol} at ${current_price:.2f}, P&L: ${pnl:.2f}"
                    )
