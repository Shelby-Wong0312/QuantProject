...
class CapitalComStockFetcher:
    ...
    def filter_stocks(self, markets: List[Dict]) -> List[str]:
        ...
        for market in markets:
            ...
            if instrument_type in ['SHARES', 'STOCK', 'EQUITY'] or \
               'SHARES' in instrument_type.upper() or \
               'STOCK' in instrument_type.upper():
...
def main():
    ...
    if not markets:
        ...
        us_stocks = [
            ...
            'PYPL', 'SQ', 'SHOP', 'UBER', 'LYFT', 'SNAP', 'PINS', 'TWTR',
            'ABNB', 'DASH', 'COIN', 'HOOD', 'RBLX', 'PLTR', 'SNOW', 'NET',
            'DDOG', 'ZM', 'DOCU', 'OKTA', 'TWLO', 'TEAM', 'CRWD', 'PANW',
            
            # Finance
            'JPM', 'BAC', 'WFC', 'GS', 'MS', 'C', 'USB', 'PNC', 'BK', 'AXP',
            'V', 'MA', 'COF', 'DFS', 'BLK', 'SCHW', 'ICE', 'CME', 'SPGI',
            
            # Healthcare
            'JNJ', 'UNH', 'PFE', 'ABBV', 'TMO', 'ABT', 'CVS', 'MRK', 'LLY',
            'BMY', 'AMGN', 'GILD', 'MDT', 'DHR', 'ISRG', 'SYK', 'BSX', 'EW',
            'REGN', 'VRTX', 'MRNA', 'BIIB', 'ILMN',
            
            # Consumer
            'WMT', 'HD', 'PG', 'KO', 'PEP', 'COST', 'NKE', 'MCD', 'SBUX',
            'TGT', 'LOW', 'CVX', 'XOM', 'DIS', 'CMCSA', 'NFLX', 'T', 'VZ',
            
            # Industrial
            'BA', 'CAT', 'DE', 'UPS', 'FDX', 'LMT', 'RTX', 'GE', 'MMM',
            'HON', 'UNP', 'CSX', 'NSC', 'EMR', 'ETN', 'ITW', 'PH', 'ROK',
            
            # More tech and growth
            'ROKU', 'TTD', 'SPOT', 'ZS', 'ESTC', 'MDB', 'FSLY', 'FVRR',
            'UPWK', 'SE', 'MELI', 'CPNG', 'GRAB', 'NU', 'RIVN', 'LCID',
            'NIO', 'XPEV', 'LI', 'BABA', 'JD', 'PDD', 'BIDU', 'BILI',
            'TSM', 'ASML', 'ARM', 'SMCI', 'AVGO', 'QCOM', 'MU', 'LRCX',
            'KLAC', 'AMAT', 'ADI', 'MRVL', 'NXPI', 'MCHP', 'TXN', 'XLNX'
        ]
        
        # Chinese ADRs
        china_stocks = [
            'BABA', 'JD', 'PDD', 'BIDU', 'NIO', 'XPEV', 'LI', 'BILI',
            'IQ', 'TME', 'VIPS', 'WB', 'BGNE', 'TAL', 'EDU', 'DIDI'
        ]
        
        # European stocks (if available)
        eu_stocks = [
            'ASML', 'SAP', 'NVO', 'AZN', 'SHEL', 'TM', 'NVS', 'HSBC',
            'BP', 'TOT', 'SNY', 'GSK', 'DEO', 'BUD', 'UL', 'RIO'
        ]
