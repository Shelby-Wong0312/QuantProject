...
class TrainingReportGenerator:
    ...
    def generate_html_report(self):
        ...
        avg_win = np.mean([r for r in self.episode_rewards if r > 0]) if any(r > 0 for r in self.episode_rewards) else 0
        avg_loss = np.mean([r for r in self.episode_rewards if r < 0]) if any(r < 0 for r in self.episode_rewards) else 0
