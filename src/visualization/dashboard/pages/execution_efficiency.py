                                                        ...
                                                        [
                                                            ...
                                                            dbc.ButtonGroup(
                                                                [
                                                                    dbc.Button(
                                                                        "刷新",
                                                                        id="refresh-efficiency",
                                                                        color="primary",
                                                                    ),
                                                                    dbc.Button(
                                                                        "導出報告",
                                                                        id="export-efficiency",
                                                                        color="secondary",
                                                                    ),
                                                                ]
                                                            ),
...
@callback(
    ...
    [Input("model-selector", "value"), Input("data-source", "value")],
)
def store_efficiency_data(model, source):
    """Store selected model data for other components"""
    return {"model": model, "source": source, "timestamp": datetime.now().isoformat()}
