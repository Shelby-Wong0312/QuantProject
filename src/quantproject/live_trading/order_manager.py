...
class OrderManager:
    ...
    async def submit_order(self, order: Dict) -> Dict:
        ...
        logger.info(f"Order {order['id']} submitted: {order['symbol']} {order['side']} {order['quantity']}")
    ...
    def get_order_stats(self) -> Dict:
        ...
        return {
            ...
            'cancelled': len([o for o in self.orders if o['status'] == OrderStatus.CANCELLED.value]),
