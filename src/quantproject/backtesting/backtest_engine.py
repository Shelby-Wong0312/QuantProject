...
class BacktestEngine:
        ...
        try:
            ...
            for i, date in enumerate(all_dates):
                ...
                if i % 252 == 0 and i > 0:  # Every trading year
                    ...
                    logger.info(f"Progress: {progress:.1f}% | Year {i//252} | "
    ...
    def _generate_signals(self, strategy: BaseStrategy, market_data: Dict[str, Dict], 
                         date: datetime) -> List:
        ...
        for signal in signals:
            try:
                ...
                if trade_result['success']:
                    ...
                    logger.debug(f"Executed: {symbol} {signal.signal_type.value} "
    ...
    def _calculate_position_size(self, signal, portfolio_value: float, 
    ...
    def _calculate_final_results(self, portfolio_values: List[float], 
                               returns: List[float], positions_history: List[Dict],
...
def run_backtest(strategy: BaseStrategy, data: Dict[str, pd.DataFrame], 
