    ...
    def create_sample_database(self):
        ...
        for i in range(500):  # Generate 500 sample trades
            ...
            base_price = {
                ...
                'TSLA': 200, 'AMZN': 3000, 'NVDA': 400, 'META': 250
            }[symbol]
        ...
        for trade in trades_data:
            ...
            ''', (
                ...
                trade['quantity'], trade['price'], trade['exit_price'],
                trade['fees'], trade['strategy'], trade['status']
            ))
    ...
    def demonstrate_trade_analysis(self):
        ...
        for key, value in basic_metrics.items():
            if isinstance(value, (int, float)):
                ...
                elif 'pnl' in key.lower() or 'equity' in key.lower() or 'win' in key.lower() or 'loss' in key.lower():
                    print(f"{key.replace('_', ' ').title()}: ${value:,.2f}")
                else:
