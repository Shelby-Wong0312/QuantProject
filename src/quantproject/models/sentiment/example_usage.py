...
def example_sentiment_analysis():
    ...
    for result in results:
        ...
        print(f"Probabilities: Pos={result['scores']['positive']:.3f}, "
...
def example_sentiment_scoring():
    ...
    sentiment_data = pd.DataFrame({
        ...
        'sentiment': ['positive', 'positive', 'negative', 'positive', 'positive', 'negative', 'negative'],
        'published_date': [
            datetime.now() - timedelta(hours=i) for i in [1, 3, 6, 2, 5, 1, 4]
        ]
    })
...
def example_complete_pipeline():
    ...
    results = pipeline.process_symbols(
        symbols=symbols,
    ...
    if results:
        ...
        report = pipeline.generate_sentiment_report(
            results,
            output_file='sentiment_report.txt'
        )
        print("\nGenerated Report:")
        print(report)
