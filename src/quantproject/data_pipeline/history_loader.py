...
class HistoryLoader:
    ...
    def get_bars(self, symbol: str, timeframe: TimeFrame, start_date: str, end_date: str) -> pd.DataFrame:
        """
        獲取指定時間範圍內的歷史K線數據。
        ...
        try:
            ...
            logger.info(f"成功獲取 {symbol} 從 {start_date} 到 {end_date} 的 {len(bars_df)} 筆數據。")
            return bars_df
