...
class StockGraphConstructor:
    ...
    def __init__(
        ...
        self.sector_mapping = {
            ...
            'WMT': 'Consumer', 'JNJ': 'Healthcare', 'PFE': 'Healthcare'
        }
    ...
    def build_graph(
        ...
        logger.info(f"Graph constructed with {self.graph.number_of_nodes()} nodes "
            ...
            for j in range(i + 1, len(symbols)):
                ...
                if abs(correlation) > self.correlation_threshold:
                    ...
                    if self.graph.has_edge(symbol1, symbol2):
                        ...
                        self.graph[symbol1][symbol2]['weight'] = (current_weight + abs(correlation)) / 2
