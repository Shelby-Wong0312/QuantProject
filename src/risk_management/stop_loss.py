...
class StopLoss:
    ...
    def set_fixed_stop(self, symbol: str, entry_price: float, 
                      stop_price: float, position_type: str = "long") -> None:
        """
        Set fixed stop loss
    ...
    def set_percentage_stop(self, symbol: str, entry_price: float, 
                           stop_percentage: float, position_type: str = "long") -> None:
        """
    ...
    def set_trailing_stop(self, symbol: str, entry_price: float, 
                         trail_amount: float, position_type: str = "long") -> None:
        """
    ...
    def set_atr_stop(self, symbol: str, entry_price: float, 
                    atr: float, atr_multiplier: float = 2.0, 
                    position_type: str = "long") -> None:
        """
    ...
    def update_trailing_stop(self, symbol: str, current_price: float, 
                           current_high: Optional[float] = None) -> bool:
        """
    ...
    @staticmethod
    def trailing_stop_loss(price: float, high: float, 
    ...
    @staticmethod
    def calculate_stop_distance(entry_price: float, 
