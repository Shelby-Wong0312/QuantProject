...
class MainController:
    ...
    def _generate_backtest_report(self, symbol: str):
        ...
        # Save report
        report_path = Path(f'reports/backtest_{symbol}_{datetime.now().strftime("%Y%m%d_%H%M%S")}.json')
