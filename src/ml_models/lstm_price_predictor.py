...
class LSTMPricePredictor:
    ...
    def prepare_data(self, prices: pd.DataFrame, 
        ...
        logger.info(f"Data prepared: {len(train_dataset)} training, {len(val_dataset)} validation samples")
    ...
    def predict_multiple_stocks(self, 
                              stock_prices: Dict[str, pd.DataFrame]) -> pd.DataFrame:
        """
        預測多支股票的預期收益
