...
def get_nasdaq_stocks():
    ...
    nasdaq_stocks = [
        ...
        'AMD', 'SBUX', 'INTU', 'ISRG', 'MDLZ', 'GILD', 'BKNG', 'ADP', 'FISV', 'CSX',
        'MU', 'LRCX', 'REGN', 'ATVI', 'ADSK', 'BIIB', 'ILMN', 'VRTX', 'ADI', 'MELI',
        'JD', 'BIDU', 'NTES', 'TEAM', 'WDAY', 'DOCU', 'CRWD', 'ZM', 'DXCM', 'SGEN'
    ]
...
def get_dow_jones_stocks():
    ...
    dow_stocks = [
        ...
        'MA', 'NVDA', 'BAC', 'VZ', 'KO', 'PFE', 'CSCO', 'MRK', 'CVX', 'WBA',
        'CRM', 'MCD', 'BA', 'AMGN', 'GS', 'CAT', 'HON', 'IBM', 'TRV', 'DOW'
    ]
...
def get_popular_stocks():
    ...
    popular = [
        ...
        'CRM', 'ADBE', 'NFLX', 'PYPL', 'SQ', 'SHOP', 'UBER', 'LYFT', 'SNAP', 'PINS',
        
        # 金融股
        'JPM', 'BAC', 'WFC', 'GS', 'MS', 'C', 'AXP', 'BLK', 'SPGI', 'SCHW',
        
        # 醫療保健
        'JNJ', 'UNH', 'PFE', 'CVS', 'ABBV', 'TMO', 'ABT', 'MRK', 'DHR', 'LLY',
        ...
        # 工業
        'BA', 'CAT', 'GE', 'MMM', 'UPS', 'HON', 'RTX', 'LMT', 'DE', 'EMR',
        
        # 電動車和新能源
        'TSLA', 'NIO', 'XPEV', 'LI', 'RIVN', 'LCID', 'FSR', 'PLUG', 'FCEL', 'ENPH',
        
        # 生技
        'MRNA', 'BNTX', 'REGN', 'VRTX', 'GILD', 'BIIB', 'AMGN', 'ILMN', 'ALNY', 'SGEN',
        
        # 半導體
        'NVDA', 'AMD', 'INTC', 'AVGO', 'QCOM', 'TXN', 'MU', 'MRVL', 'AMAT', 'LRCX',
        
        # 中概股
        'BABA', 'JD', 'BIDU', 'NIO', 'XPEV', 'LI', 'PDD', 'BILI', 'IQ', 'NTES'
    ]
