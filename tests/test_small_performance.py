...
def test_small_scale_performance():
    ...
    for case in test_cases:
        ...
        case_result = {
            ...
            'indicators_per_second': (case['stocks'] * total_indicators) / calc_time if calc_time > 0 else 0
        }
    ...
    print(f"  Average processing speed: {test_results['summary']['avg_processing_speed']:.1f} stocks/second")
