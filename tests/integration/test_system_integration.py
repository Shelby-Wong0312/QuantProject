...
class TestMainController(unittest.TestCase):
    ...
    async def test_process_trading_signal(self):
        ...
        await self.controller._process_trading_signal(
            symbol="AAPL", timestamp=datetime.now(), data=market_data
        )
    ...
    def test_calculate_position_size(self):
        ...
        position_size = self.controller._calculate_position_size(
            symbol="AAPL", size_pct=0.5, confidence=0.8
        )
...
class TestHealthMonitor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.monitor = HealthMonitor(components=self.mock_components, check_interval=1)
