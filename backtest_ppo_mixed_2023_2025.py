...
def generate_visualizations(metrics: Dict, results: List[Dict], output_dir: str):
    ...
    plt.title('PPO Model - Portfolio Equity Curve (2023-2025)', fontsize=14, fontweight='bold')
...
def run_full_backtest(
    ...
    # 保存Markdown報告
    report_path = os.path.join(output_dir, "local_ppo_mixed_4215_2023_2025.md")

    with open(report_path, "w", encoding="utf-8") as f:
        f.write("# PPO Mixed Model - FULL OOS Backtest Report (2023-2025)\n\n")
    ...
    # 保存JSON數據
    json_path = os.path.join(output_dir, "local_ppo_mixed_4215_2023_2025_metrics.json")
