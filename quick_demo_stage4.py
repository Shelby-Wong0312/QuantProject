...
def test_strategy_creation():
    ...
    try:
        ...
        print(f"  Parameters: BB period={mean_rev.bb_period}, RSI thresholds={mean_rev.rsi_oversold}-{mean_rev.rsi_overbought}")
    except Exception as e:
    ...
    try:
        ...
        print(f"  Parameters: Channel period={breakout.channel_period}, ATR period={breakout.atr_period}")
    except Exception as e:
...
def test_indicators():
    ...
    try:
        ...
        print(f"SUCCESS: MACD calculated: {len(macd_data)} values, columns: {list(macd_data.columns)}")
...
def test_ml_strategies():
    ...
    try:
        ...
        print(f"  Parameters: n_estimators={rf_strategy.n_estimators}, confidence_threshold={rf_strategy.confidence_threshold}")
    except ImportError:
    ...
    try:
        ...
        print(f"  Parameters: sequence_length={lstm_strategy.sequence_length}, lstm_units={lstm_strategy.lstm_units}")
    except ImportError:
