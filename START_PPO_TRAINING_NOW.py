...
MAJOR_STOCKS = [
    ...
    'PYPL', 'CSCO', 'AVGO', 'QCOM', 'TXN', 'ORCL', 'ADBE', 'CRM', 'IBM', 'NOW',
    'UBER', 'SNAP', 'PINS', 'SHOP', 'ABNB', 'COIN', 'HOOD', 'PLTR', 'SOFI', 'RIVN',
    'LCID', 'ROKU', 'ZM', 'DOCU', 'OKTA', 'TWLO', 'DDOG', 'SNOW', 'NET', 'CRWD',
    'PANW', 'ZS', 'SQ', 'RBLX', 'U', 'DASH', 'AFRM', 'UPST', 'CPNG', 'NU',
    
    # Banks & Finance
    'JPM', 'BAC', 'WFC', 'GS', 'MS', 'C', 'USB', 'PNC', 'SCHW', 'BLK',
    'V', 'MA', 'AXP', 'COF', 'ICE', 'CME', 'SPGI', 'BX', 'KKR', 'APO',
    
    # Healthcare
    'JNJ', 'UNH', 'PFE', 'ABBV', 'MRK', 'CVS', 'TMO', 'ABT', 'DHR', 'LLY',
    'BMY', 'AMGN', 'GILD', 'MDT', 'ISRG', 'SYK', 'BSX', 'EW', 'REGN', 'VRTX',
    'MRNA', 'BIIB', 'ILMN', 'DXCM', 'ALGN', 'IDXX', 'MTD', 'ZBH', 'VEEV', 'RMD',
    
    # Consumer
    'WMT', 'HD', 'PG', 'KO', 'PEP', 'COST', 'NKE', 'MCD', 'SBUX', 'TGT',
    'LOW', 'TJX', 'ROST', 'DG', 'DLTR', 'BBY', 'AZO', 'ORLY', 'YUM', 'CMG',
    'DPZ', 'QSR', 'WEN', 'BROS', 'CAVA', 'LULU', 'DECK', 'TPR', 'RL', 'GPS',
    
    # Energy
    'XOM', 'CVX', 'COP', 'SLB', 'EOG', 'MPC', 'VLO', 'PSX', 'OXY', 'HAL',
    'BKR', 'DVN', 'FANG', 'HES', 'APA', 'MRO', 'CTRA', 'OVV', 'MTDR', 'CHRD',
    
    # Industrials
    'BA', 'CAT', 'DE', 'LMT', 'RTX', 'GE', 'MMM', 'HON', 'UPS', 'FDX',
    'UNP', 'CSX', 'NSC', 'ETN', 'EMR', 'ITW', 'PH', 'CMI', 'ROK', 'AME',
    
    # Chinese Stocks
    'BABA', 'JD', 'PDD', 'BIDU', 'NIO', 'XPEV', 'LI', 'BILI', 'IQ', 'TME',
    'VIPS', 'WB', 'TAL', 'EDU', 'BEKE', 'NTES', 'TCOM', 'ZTO', 'DIDI', 'BGNE',
    
    # ETFs
    'SPY', 'QQQ', 'IWM', 'DIA', 'VOO', 'VTI', 'IVV', 'VEA', 'VWO', 'EEM',
    'XLF', 'XLK', 'XLE', 'XLV', 'XLI', 'XLY', 'XLP', 'XLB', 'XLU', 'XLRE',
    'VNQ', 'GLD', 'SLV', 'USO', 'UNG', 'TLT', 'IEF', 'SHY', 'AGG', 'BND',
    'HYG', 'JNK', 'EMB', 'ARKK', 'ARKQ', 'ARKW', 'ARKG', 'ARKF', 'ICLN', 'TAN',
    
    # Other notable stocks
    'DIS', 'T', 'VZ', 'CMCSA', 'NFLX', 'TMUS', 'CHTR', 'WBD', 'PARA', 'FOX',
    'F', 'GM', 'TSLA', 'RIVN', 'LCID', 'NIO', 'FSR', 'RIDE', 'GOEV', 'ARVL',
    'TSM', 'ASML', 'AMAT', 'LRCX', 'KLAC', 'MU', 'MRVL', 'ON', 'SWKS', 'QRVO',
    'BRK.B', 'JPM', 'BAC', 'WFC', 'USB', 'GS', 'MS', 'C', 'AXP', 'V'
]
