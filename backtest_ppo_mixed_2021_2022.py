...
def run_full_backtest(
    ...
    # 保存Markdown報告
    report_path = os.path.join(output_dir, "local_ppo_mixed_4215_2021_2022.md")

    with open(report_path, "w", encoding="utf-8") as f:
        f.write("# PPO Mixed Model - FULL OOS Backtest Report (2021-2022)\n\n")
    ...
    # 保存JSON數據
    json_path = os.path.join(output_dir, "local_ppo_mixed_4215_2021_2022_metrics.json")
