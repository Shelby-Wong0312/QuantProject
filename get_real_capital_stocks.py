    ...
    def search_us_stocks(self):
        ...
        for term in search_terms:
            ...
            for market in markets:
                ...
                # 篩選股票類型
                if 'SHARES' in instrument_type.upper() or \
                   'STOCK' in instrument_type.upper() or \
                   'EQUITY' in instrument_type.upper() or \
                   (epic and not any(x in epic.upper() for x in ['INDEX', 'FX', 'COMMODITY', 'CRYPTO'])):
...
def get_comprehensive_stock_list():
    ...
    major_us_stocks = [
        ...
        'NFLX', 'PYPL', 'CSCO', 'AVGO', 'QCOM', 'TXN', 'ORCL', 'ADBE', 'CRM',
        'IBM', 'NOW', 'UBER', 'SNAP', 'PINS', 'SHOP', 'ABNB', 'COIN', 'HOOD',
        'PLTR', 'SOFI', 'RIVN', 'LCID', 'NIO', 'XPEV', 'LI', 'ROKU', 'ZM',
        'DOCU', 'OKTA', 'TWLO', 'DDOG', 'SNOW', 'NET', 'CRWD', 'PANW', 'ZS',
        
        # 金融
        'JPM', 'BAC', 'WFC', 'GS', 'MS', 'C', 'USB', 'PNC', 'SCHW', 'BLK',
        'V', 'MA', 'AXP', 'COF', 'ICE', 'CME', 'SPGI', 'MCO', 'MSCI', 'TROW',
        
        # 醫療保健
        'JNJ', 'UNH', 'PFE', 'ABBV', 'CVS', 'MRK', 'TMO', 'ABT', 'DHR', 'LLY',
        'BMY', 'AMGN', 'GILD', 'MDT', 'ISRG', 'SYK', 'BSX', 'EW', 'REGN', 'VRTX',
        'MRNA', 'BIIB', 'ILMN', 'IDXX', 'ALGN', 'DXCM', 'MTD', 'WST', 'ZBH',
        
        # 消費
        'WMT', 'HD', 'PG', 'KO', 'PEP', 'COST', 'NKE', 'MCD', 'SBUX', 'TGT',
        'LOW', 'TJX', 'ROST', 'DG', 'DLTR', 'BBY', 'AZO', 'ORLY', 'YUM', 'CMG',
        
        # 工業
        'BA', 'CAT', 'DE', 'UPS', 'FDX', 'LMT', 'RTX', 'GE', 'MMM', 'HON',
        'UNP', 'CSX', 'NSC', 'EMR', 'ETN', 'ITW', 'PH', 'ROK', 'FTV', 'AME',
        
        # 能源
        'XOM', 'CVX', 'COP', 'SLB', 'EOG', 'PXD', 'MPC', 'VLO', 'PSX', 'OXY',
        'KMI', 'WMB', 'ET', 'EPD', 'ENB', 'TRP', 'LNG', 'FANG', 'DVN', 'HES',
        ...
        # 公用事業
        'NEE', 'DUK', 'SO', 'D', 'EXC', 'SRE', 'AEP', 'XEL', 'ED', 'PEG',
    ...
    # 中概股
    china_stocks = [
        'BABA', 'JD', 'PDD', 'BIDU', 'BILI', 'IQ', 'TME', 'VIPS', 'WB',
        'TAL', 'EDU', 'BEKE', 'NTES', 'TCOM', 'ZTO', 'YMM', 'HUYA', 'DOYU'
    ]
    
    # ETF
    etfs = [
        'SPY', 'QQQ', 'IWM', 'DIA', 'VOO', 'VTI', 'IVV', 'VEA', 'VWO', 'EEM',
        'XLF', 'XLK', 'XLE', 'XLV', 'XLI', 'XLY', 'XLP', 'XLB', 'XLU', 'XLRE',
        'VNQ', 'GLD', 'SLV', 'USO', 'UNG', 'TLT', 'IEF', 'SHY', 'AGG', 'BND',
        'HYG', 'JNK', 'EMB', 'ARKK', 'ARKQ', 'ARKW', 'ARKG', 'ARKF', 'ICLN'
    ]
