...
class FileBridge:
    def __init__(self, commands_dir: str = "C:/MT4_Bridge/Commands/", 
    ...
    def wait_response(self, command_id: str = None, timeout: float = 5.0) -> Optional[Dict[str, Any]]:
        """等待回應"""
    ...
    def place_order(self, symbol: str, order_type: str, volume: float,
                   price: float = 0, sl: float = 0, tp: float = 0) -> Dict[str, Any]:
        """下單"""
