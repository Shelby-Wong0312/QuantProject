...
class MT4FolderPreparer:
    ...
    def __init__(self, mt4_path: str = None, verbose: bool = False, force: bool = False):
        ...
        # ZeroMQ 相關目錄
        self.zeromq_directories = ["MQL4/Libraries/zmq", "MQL4/Include/zmq"]
    ...
    def create_python_bridge_directories(self) -> bool:
        ...
        self.log(
            f"Python 橋接目錄建立完成: {success_count}/{len(self.python_bridge_directories)}",
            "success",
        )
    ...
    def _get_python_bridge_config(self) -> Dict:
        ...
        return {
            ...
            "working_directory": os.path.join(
                self.mt4_path, "MQL4", "Files", "bridge", "python", "src"
            ),
            "auto_start": True,
            "restart_on_error": True,
            "max_restart_attempts": 5,
            "log_level": "INFO",
            "dependencies": ["pandas", "numpy", "pyzmq"],
            "created_at": time.strftime("%Y-%m-%d %H:%M:%S"),
            "version": "1.0.0",
        }
...
"""
        ...
        return {
            ...
            "summary": {
                ...
                "overall_status": (
                    ...
                    else "PARTIAL" if len(self.created_folders) > 0 else "FAILED"
                ),
            },
        }
    ...
    def print_final_summary(self, report: Dict):
        ...
        status_color, status_text = status_map.get(
            report["summary"]["overall_status"], ("❓", "未知狀態")
        )
